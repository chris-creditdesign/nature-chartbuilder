...
/*
	SessionStore
	Flux store for the current session, ie session data that persists regardless
	of interaction. Includes locale-aware settings and are unrelated to the actual
